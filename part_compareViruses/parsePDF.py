#by https://github.com/dpapathanasiou/pdfminer-layout-scanner/blob/master/layout_scanner.py
...
def main():
    print get_pages(pdf_doc="051.pdf", images_folder='C:/Users/Mimi/Desktop/test')
